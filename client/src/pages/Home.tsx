import { Heart, MessageCircle, Menu, X, Sparkles, Star, ChevronUp, Palette, Package, Clock, Brush } from "lucide-react";
...
const bestsellers = [
  {
    ...
    img: "/sunflower-bouquet.png", tag: "Most Loved 🌻", tagColor: "bg-amber-100 text-amber-800", price: "₹189",
  },
  {
    id: 2, name: "Crochet Keychains",
    desc: "Tiny handmade charms — flowers, hearts, strawberries, stars, bows & more. Perfect little gifts.",
    img: "/keychain-bestseller.png", tag: "Fan Favourite 🔑", tagColor: "bg-pink-100 text-pink-700", price: "Starting ₹60",
  },
];

const flowerProducts = [
  { name: "Sunflower Bouquet", img: "/sunflower-bouquet.png", price: "₹189" },
  { name: "Pipe Cleaner Sunflower", img: "/sunflower-pipe.png", price: "₹189" },
  { name: "Pink Rose", img: "/pink-rose.png", price: "₹120+" },
  { name: "Pink Peonies", img: "/pink-peonies.png", price: "₹199+" },
  { name: "Pink Tulips", img: "/pink-tulips.png", price: "₹120" },
];
    ...
    <div className="min-h-screen bg-amber-50 overflow-x-hidden">
      ...
      <motion.nav initial={{ y: -60, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5, delay: 0.1 }}
        ...
        <div className="container flex items-center justify-between py-3">
          <motion.div className="flex items-center gap-3" whileHover={{ scale: 1.03 }} transition={{ type: "spring", stiffness: 400 }}>
            <img src="/logo.png" alt="Plushie Knots"
      ...
      <section id="products" className="py-20 md:py-28 bg-gradient-to-b from-amber-50 to-rose-50">
        <div className="container max-w-5xl mx-auto">
          ...
          <div className="mb-14">
            <Reveal>
              <div className="flex items-center gap-4 mb-3">
                ...
                <h3 className="text-base font-bold text-amber-900 whitespace-nowrap">🌸 Pipe Cleaner Flowers</h3>
                <div className="h-px flex-1 bg-pink-100" />
              </div>
              <p className="text-center text-amber-500 text-xs mb-8">Forever blooms — they never wilt 🌻</p>
            </Reveal>
          ...
          {/* Catalog images */}
          {[
            { title: "🌺 All Flower Varieties", img: "/pipe-cleaner-catalog.png", alt: "Full flower catalog" },
            { title: "🧸 Keychains, AirPods & Coin Purses", img: "/accessories-catalog.png", alt: "Accessories catalog" },
          ].map(({ title, img, alt }) => (
      ...
      <footer className="py-14 bg-amber-50 border-t border-pink-100">
        <div className="container text-center">
          <motion.img src="/logo.png" alt="Plushie Knots" whileHover={{ scale: 1.1, rotate: 5 }}
      ...
      <motion.a href={generalWhatsapp} target="_blank" rel="noopener noreferrer"
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-green-500 text-white font-semibold px-4 py-3.5 rounded-full shadow-xl"
        style={{ boxShadow: "0 6px 24px rgba(34,197,94,0.45)" }}>
        <motion.div animate={{ rotate: [0, -15, 15, -10, 0] }} transition={{ duration: 2, repeat: Infinity, repeatDelay: 4 }}>
